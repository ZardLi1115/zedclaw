...
Config: ~/.zedclaw/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.zedclaw/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zedclaw_home()`` helper (ZEDCLAW_HOME-aware and
...
RULES_FILE = get_zedclaw_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zedclaw_home() / "feishu_comment_pairing.json"
