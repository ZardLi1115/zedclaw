"""
Email platform adapter for the ZedClaw gateway.

Allows users to interact with ZedClaw by sending emails.
...
def _send_imap_id(imap: "imaplib.IMAP4") -> None:
    ...
    try:
        ...
        imap.xatom(
            "ID",
            f'("name" "zedclaw" "version" "{_zedclaw_version}" '
            '"vendor" "NousResearch" '
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "ZedClaw")
        ...
        msg_id = f"<zedclaw-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
