...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._media_batch_delay_seconds = float(os.getenv("ZEDCLAW_TELEGRAM_MEDIA_BATCH_DELAY_SECONDS", "0.8"))
        ...
        self._text_batch_delay_seconds = self._env_float_clamped(
            "ZEDCLAW_TELEGRAM_TEXT_BATCH_DELAY_SECONDS",
            0.3,
            min_value=0.08,
            max_value=2.0,
        )
        self._text_batch_split_delay_seconds = self._env_float_clamped(
            "ZEDCLAW_TELEGRAM_TEXT_BATCH_SPLIT_DELAY_SECONDS",
            1.0,
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. ZedClaw-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "(possibly OpenClaw or another ZedClaw instance). "
            "ZedClaw stopped Telegram polling after %d retries. "
            "Only one poller can run per token — stop the other process "
            "and restart with 'zedclaw start'."
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            request_kwargs = {
                "connection_pool_size": _env_int("ZEDCLAW_TELEGRAM_HTTP_POOL_SIZE", 512),
                "pool_timeout": _env_float("ZEDCLAW_TELEGRAM_HTTP_POOL_TIMEOUT", 8.0),
                "connect_timeout": _env_float("ZEDCLAW_TELEGRAM_HTTP_CONNECT_TIMEOUT", 10.0),
                "read_timeout": _env_float("ZEDCLAW_TELEGRAM_HTTP_READ_TIMEOUT", 20.0),
                "write_timeout": _env_float("ZEDCLAW_TELEGRAM_HTTP_WRITE_TIMEOUT", 20.0),
            }

            disable_fallback = (os.getenv("ZEDCLAW_TELEGRAM_DISABLE_FALLBACK_IPS", "").strip().lower() in {"1", "true", "yes", "on"})
            ...
            if webhook_url:
                ...
                if not webhook_secret:
                    raise RuntimeError(
                        ...
                        "https://github.com/NousResearch/zedclaw/"
            ...
            try:
                ...
                from zedclaw_cli.commands import telegram_menu_commands
    ...
    async def send_typing(self, chat_id: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        ...
        if self._bot:
            try:
                ...
                # Skip the Bot API call entirely for ZedClaw-created DM topic
    ...
    def _message_mentions_bot(self, message: Message) -> bool:
        ...
        # raw substring matches like "foo@zedclaw_bot.example" are not mentions
