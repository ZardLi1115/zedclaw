...
# Uses get_zedclaw_home() so each profile gets its own Matrix store.
from zedclaw_constants import get_zedclaw_dir as _get_zedclaw_dir

_STORE_DIR = _get_zedclaw_dir("platforms/matrix/store", "matrix/store")
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(
            os.getenv("ZEDCLAW_MATRIX_TEXT_BATCH_DELAY_SECONDS", "0.6")
        )
        self._text_batch_split_delay_seconds = float(
            os.getenv("ZEDCLAW_MATRIX_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0")
        )
    ...
    async def connect(self) -> bool:
        ...
        if self._encryption:
            ...
            try:
                ...
                _acct_id = self._user_id or "zedclaw"
    ...
    def _strip_mention(self, body: str) -> str:
        ...
        otherwise normal phrases like "ZedClaw" become "Agent".
        """
        if not body:
            return ""
