...
try:
    ...
    _ZEDCLAW_VERSION = "0.0.0"

_APP_VERSION = _ZEDCLAW_VERSION
_BOT_VERSION = _ZEDCLAW_VERSION
_YUANBAO_INSTANCE_ID = str(ZEDCLAW_INSTANCE_ID)  # single source: yuanbao_proto.ZEDCLAW_INSTANCE_ID
