...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_zedclaw_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.zedclaw/config.yaml (primary user-facing config)
    3. ~/.zedclaw/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_zedclaw_home()
    gw_data: dict = {}
