...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), ZedClaw
license: MIT
...
The script reads `~/.zedclaw/.env` for two optional defaults:
...
Helper script: `~/.zedclaw/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.zedclaw/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.zedclaw/.env`.
...
```bash
python3 ~/.zedclaw/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.zedclaw/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
