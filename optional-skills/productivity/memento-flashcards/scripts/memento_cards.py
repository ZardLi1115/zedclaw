...
Data file: $ZEDCLAW_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZEDCLAW_HOME = Path(os.environ.get("ZEDCLAW_HOME", Path.home() / ".zedclaw"))
DATA_DIR = _ZEDCLAW_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
