---
name: zedclaw-atropos-environments
description: Build, test, and debug ZedClaw RL environments for Atropos training. Covers the ZedClawAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the zedclaw repo.
version: 1.1.0
author: ZedClaw
license: MIT
