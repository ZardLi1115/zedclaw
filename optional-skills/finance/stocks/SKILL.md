...
```
SCRIPT=~/.zedclaw/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.zedclaw/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
