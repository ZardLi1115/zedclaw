...
def auth_json_path():
    """Return the ZedClaw auth store path, respecting ZEDCLAW_HOME overrides."""
    return get_zedclaw_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from zedclaw_cli.auth import resolve_nous_access_token
