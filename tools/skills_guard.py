...
Trust levels:
  - builtin:   Ships with ZedClaw. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zedclaw/\.env|\~/\.zedclaw/\.env',
     "zedclaw_env_access", "critical", "exfiltration",
     "directly references ZedClaw secrets file"),
    ...
    (r'\.zedclaw/config\.yaml|\.zedclaw/SOUL\.md',
     "zedclaw_config_mod", "critical", "persistence",
     "references ZedClaw configuration files directly"),
