# Streaming LLM Response Support for ZedClaw
...
```
ZEDCLAW_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZEDCLAW_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zedclaw_cli/config.py` | 1 | +streaming config defaults |
...
ZEDCLAW_STREAMING_ENABLED=true
```
