"""
Skills configuration for ZedClaw.
`zedclaw skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zedclaw/config.yaml under:
...
from zedclaw_cli.config import cfg_get, load_config, save_config
from zedclaw_cli.colors import Colors, color
from zedclaw_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `zedclaw skills`."""
    from zedclaw_cli.curses_ui import curses_checklist
