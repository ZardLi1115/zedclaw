...
Used by ``zedclaw kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``zedclaw_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the ZedClaw board.
...
def _profile_author() -> str:
    """Mirror of ``zedclaw_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("ZEDCLAW_PROFILE")
