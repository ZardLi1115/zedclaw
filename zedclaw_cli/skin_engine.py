"""ZedClaw CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.zedclaw/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ZedClaw"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ ZedClaw "       # Response box header label
...
.. code-block:: python
    ...
    from zedclaw_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "ZedClaw"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.zedclaw/skins/
...
Drop a YAML file in ``~/.zedclaw/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZEDCLAW_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZEDCLAW_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic ZedClaw — gold and kawaii",
        "colors": {
            "banner_border": "#8A2BFF",
            "banner_title": "#00E5FF",
            "banner_accent": "#00D9FF",
            "banner_dim": "#6E5CFF",
            "banner_text": "#E9FBFF",
            "ui_accent": "#00D9FF",
            "ui_label": "#B218FF",
            ...
            "status_bar_bg": "#111018",
            "session_label": "#00D9FF",
            "session_border": "#6E5CFF",
        },
        "spinner": {
        ...
        "branding": {
            "agent_name": "ZedClaw",
            "welcome": "Welcome to ZedClaw! Type your message or /help for commands.",
            "goodbye": "Goodbye! ◢",
            "response_label": " ◢ ZedClaw ",
            "prompt_symbol": "❯",
