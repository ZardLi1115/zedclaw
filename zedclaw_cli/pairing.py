...
Usage:
    zedclaw pairing list              # Show all pending + approved users
    zedclaw pairing approve <platform> <code>  # Approve a pairing code
    zedclaw pairing revoke <platform> <user_id> # Revoke user access
    zedclaw pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zedclaw pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zedclaw pairing {list|approve|revoke|clear-pending}")
        print("Run 'zedclaw pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.zedclaw/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'zedclaw pairing list' to see pending codes.\n")
