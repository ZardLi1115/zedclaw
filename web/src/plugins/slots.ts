 ...
 * `window.__ZEDCLAW_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the ZedClaw brand in the top bar
 ...
 *  `window.__ZEDCLAW_PLUGINS__.registerSlot(...)`.
 *
