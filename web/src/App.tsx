          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="zedclaw-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="zedclaw-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateZedClaw,
      runningLabel: t.status.updatingZedClaw,
      spin: false,
    },
  ];
