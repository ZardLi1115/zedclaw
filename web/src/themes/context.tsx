...
const STORAGE_KEY = "zedclaw-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zedclaw_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "zedclaw-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-zedclaw-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-zedclaw-theme-font", "true");
