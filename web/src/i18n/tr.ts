...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateZedClaw: "ZedClaw'i Güncelle",
    updatingZedClaw: "ZedClaw güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "ZedClaw eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`zedclaw plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.zedclaw/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.zedclaw/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.zedclaw/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk ZedClaw rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "ZedClaw oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "ZedClaw'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. ZedClaw ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "ZedClaw yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
