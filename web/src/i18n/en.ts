...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateZedClaw: "Update ZedClaw",
    updatingZedClaw: "Updating ZedClaw…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update ZedClaw plugins (`zedclaw plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.zedclaw/plugins/?",
    removeHint: "Only user-installed plugins under ~/.zedclaw/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.zedclaw/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible ZedClaw badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning ZedClaw session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run ZedClaw more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once ZedClaw sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "ZedClaw is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
