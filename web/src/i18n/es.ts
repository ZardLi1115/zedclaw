...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateZedClaw: "Actualizar ZedClaw",
    updatingZedClaw: "Actualizando ZedClaw…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de ZedClaw (equivalente a `zedclaw plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.zedclaw/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.zedclaw/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.zedclaw/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de ZedClaw ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de ZedClaw. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa ZedClaw más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que ZedClaw detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "ZedClaw está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
