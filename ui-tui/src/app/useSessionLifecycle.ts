...
import type { ScrollBoxHandle } from '@zedclaw/ink'
import { evictInkCaches } from '@zedclaw/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZEDCLAW_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
