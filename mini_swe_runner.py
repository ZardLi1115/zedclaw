#!/usr/bin/env python3
"""
SWE Runner with ZedClaw Trajectory Format

A runner that uses ZedClaw-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ZedClaw-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ZedClaw-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ZedClaw format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ZedClaw-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ZedClaw-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ZedClaw Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ZedClaw-Agent's built-in execution environments
    and outputs trajectories in ZedClaw-Agent format.
    """
    ...
    def _convert_to_zedclaw_format(
        self,
        ...
        """
        Convert internal message format to ZedClaw trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ZedClaw trajectory format
        trajectory = self._convert_to_zedclaw_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with ZedClaw trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ZedClaw Trajectory Format")
    print("=" * 60)
