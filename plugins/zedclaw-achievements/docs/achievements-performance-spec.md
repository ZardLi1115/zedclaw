# ZedClaw Achievements Performance Spec (Post-Hackathon)

Status: Draft (no code changes yet)
Owner: zedclaw-achievements plugin
...
### `GET /api/plugins/zedclaw-achievements/achievements`
...
### `POST /api/plugins/zedclaw-achievements/rescan` (optional)
Manual refresh trigger.
Prefer async trigger + immediate status response.

### `GET /api/plugins/zedclaw-achievements/scan-status` (optional new)
Reports scan state for UX/ops.

### Removed
- `GET /api/plugins/zedclaw-achievements/overview`
...
- Persist plugin data under:
  - `~/.zedclaw/plugins/zedclaw-achievements/scan_snapshot.json`

### Phase 2
- Incremental scan checkpoints with per-session fingerprints.
- Persist checkpoint data under:
  - `~/.zedclaw/plugins/zedclaw-achievements/scan_checkpoint.json`
...
- `~/.zedclaw/plugins/zedclaw-achievements/`
