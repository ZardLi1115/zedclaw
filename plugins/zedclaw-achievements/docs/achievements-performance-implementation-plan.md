# ZedClaw Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.zedclaw/plugins/zedclaw-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.zedclaw/plugins/zedclaw-achievements/scan_checkpoint.json`.
