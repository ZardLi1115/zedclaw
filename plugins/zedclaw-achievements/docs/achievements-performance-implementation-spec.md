# ZedClaw Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.zedclaw/plugins/zedclaw-achievements/state.json` (existing unlock state)
  - `~/.zedclaw/plugins/zedclaw-achievements/scan_snapshot.json` (new)
  - `~/.zedclaw/plugins/zedclaw-achievements/scan_checkpoint.json` (new)
