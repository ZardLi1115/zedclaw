...
``_check_spotify_available()`` — when the user has not run ``zedclaw auth
spotify``, the tools remain registered (so they appear in ``zedclaw
...
The Spotify auth flow (``zedclaw auth spotify``), CLI plumbing, and docs
