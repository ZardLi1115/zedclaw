"""
Monkey patches for making zedclaw tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by zedclaw_base_env.py).
