...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from ZedClaw"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from ZedClaw",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from ZedClaw",
    },
    {
...
class TerminalTestEnv(ZedClawAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/zedclaw/.env.
        """
