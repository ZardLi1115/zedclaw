...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs ZedClawAgentLoop with terminal tool only
...
Requires: pip install zedclaw[yc-bench]
"""
...
class YCBenchEvalConfig(ZedClawAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends ZedClawAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(ZedClawAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The ZedClawAgentLoop then drives the
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs ZedClawAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our ZedClawAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the ZedClawAgentLoop
            # ----------------------------------------------------------
