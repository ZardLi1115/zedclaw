...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("zedclaw")
        class ZedClawToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "zedclaw", "mistral", "llama3_json")
...
from environments.tool_call_parsers.zedclaw_parser import ZedClawToolCallParser  # noqa: E402, F401
