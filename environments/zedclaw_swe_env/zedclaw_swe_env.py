"""
ZedClawSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser zedclaw
    run-api
    python environments/zedclaw_swe_env.py serve \\
...
class ZedClawSweEnv(ZedClawAgentBaseEnv):
    ...
    name = "zedclaw-swe"
    env_config_cls = ZedClawSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[ZedClawSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = ZedClawSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepZedClaw-3-Llama-3-3B-Preview",
            tool_call_parser="zedclaw",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="zedclaw-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepZedClaw-3-Llama-3-3B-Preview",
