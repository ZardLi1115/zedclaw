...
Inspired by: GroceryMind — production ZedClaw doing live web research
             across German grocery stores (firecrawl + zedclaw)
"""
...
# Ensure zedclaw root is on path
...
class WebResearchEnvConfig(ZedClawAgentEnvConfig):
...
class WebResearchEnv(ZedClawAgentBaseEnv):
    """
