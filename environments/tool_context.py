...
ALL zedclaw tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all zedclaw tools for a specific rollout.
    ...
    def upload_file(self, local_path: str, remote_path: str) -> Dict[str, Any]:
        ...
        if len(b64) <= chunk_size:
            ...
            tmp_b64 = "/tmp/_zedclaw_upload.b64"
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("ZEDCLAW_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("ZEDCLAW_QUIET", None)
            else:
                os.environ["ZEDCLAW_QUIET"] = _prev_quiet
