#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the ZedClaw docs site.
...
Both publish at:
  https://zedclaw.nousresearch.com/docs/llms.txt
  https://zedclaw.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://zedclaw.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use ZedClaw as a Python Library", None),
        ("guides/use-mcp-with-zedclaw", "Use MCP with ZedClaw", None),
        ("guides/use-voice-mode-with-zedclaw", "Use Voice Mode with ZedClaw", None),
        ("guides/use-soul-with-zedclaw", "Use SOUL.md with ZedClaw", None),
        ("guides/build-a-zedclaw-plugin", "Build a ZedClaw Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with ZedClaw"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "zedclaw/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/zedclaw")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# ZedClaw — Full Documentation\n",
        (
            "This file is the entire ZedClaw documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using ZedClaw, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://zedclaw.nousresearch.com/docs\n",
        "Short index: https://zedclaw.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
