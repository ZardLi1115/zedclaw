  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the ZedClaw community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use ZedClaw &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with ZedClaw?{' '}
        <a
          href="https://github.com/NousResearch/zedclaw/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
