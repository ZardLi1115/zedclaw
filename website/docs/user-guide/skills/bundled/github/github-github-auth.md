...
- Give it a title like "zedclaw-&lt;machine-name>"
...
elif [ -f ~/.zedclaw/.env ] && grep -q "^GITHUB_TOKEN=" ~/.zedclaw/.env; then
  export GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" ~/.zedclaw/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
  echo "AUTH_METHOD=curl"
