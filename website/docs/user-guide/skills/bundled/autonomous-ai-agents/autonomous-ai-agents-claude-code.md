...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`zedclaw`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-zedclaw), [`opencode`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode) |
