...
```python
import sys
sys.path.insert(0, "/home/teknium/.zedclaw/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.zedclaw/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — ZedClaw installs package this)
