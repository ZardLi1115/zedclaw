...
```bash
python3 -m pyfiglet "ZEDCLAW" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ZEDCLAW&font=Slant" | boxes -d stone
```
