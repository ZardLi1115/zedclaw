...
Control the user's Spotify account via the ZedClaw Spotify toolset (7 tools). Setup guide: https://zedclaw.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `zedclaw auth spotify` again.
