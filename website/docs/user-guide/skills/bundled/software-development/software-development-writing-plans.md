...
| Version | `1.1.0` |
| Author | ZedClaw (adapted from obra/superpowers) |
| License | MIT |
...
> **For ZedClaw:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use ZedClaw tools to understand the project:
