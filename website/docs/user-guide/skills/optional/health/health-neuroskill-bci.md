...
| | |
|---|---|
| Source | Optional — install with `zedclaw skills install official/health/neuroskill-bci` |
...
Connect ZedClaw to a running [NeuroSkill](https://neuroskill.com/) instance to read
