...
- User wants **ZedClaw itself to drive a browser** → use ZedClaw' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
