...
| | |
|---|---|
| Source | Optional — install with `zedclaw skills install official/research/qmd` |
...
ZedClaw via the native MCP client. This is the preferred
...
Then configure ZedClaw to connect via HTTP:
