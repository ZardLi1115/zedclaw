...
| | |
|---|---|
| Source | Optional — install with `zedclaw skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"ZedClaw","productType":"Apparel","tags":["test"]}}'
```
