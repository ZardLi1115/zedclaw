...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - zedclaw_home (str): The active ZEDCLAW_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.zedclaw``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "zedclaw").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'zedclaw memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], zedclaw_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'zedclaw memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``zedclaw_home`` is the active ZEDCLAW_HOME directory path.
