...
(3 SDK retries x 3 ZedClaw retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_zedclaw_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".zedclaw")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, ZedClaw, ...) behind one endpoint.  A 429 can mean either:
