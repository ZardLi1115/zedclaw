#!/usr/bin/env python3
"""Build the ZedClaw Model Catalog — a centralized JSON manifest of curated models.
...
ZedClaw CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ZedClaw release.
...
# Ensure ZEDCLAW_HOME is set for imports that touch it at module level.
os.environ.setdefault("ZEDCLAW_HOME", os.path.join(os.path.expanduser("~"), ".zedclaw"))

from zedclaw_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "zedclaw repo",
            "docs": "https://zedclaw.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
