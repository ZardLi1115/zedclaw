...
VERSION_FILE = REPO_ROOT / "zedclaw_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+zedclaw-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "zedclaw@nousresearch.com": "NousResearch",
    ...
    "zedclaw@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (ZEDCLAW_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (ZEDCLAW_HOME inject)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "zedclaw@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/zedclaw",
    ...
    lines.append(f"# ZedClaw v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for ZedClaw. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="ZedClaw Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  ZedClaw Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"ZedClaw v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"ZedClaw v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'ZedClaw v{new_version} ({calver_date})' "
