...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zedclaw-megascience-sft1",
    "NousResearch/ZedClaw-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/ZedClaw-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zedclaw"
]
