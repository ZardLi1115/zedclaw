#!/usr/bin/env python3
"""Build the ZedClaw Skills Index — a centralized JSON catalog of all skills.
...
`zedclaw skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZEDCLAW_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building ZedClaw Skills Index...", flush=True)
