...
def worker_loop(worker_id: int, zedclaw_home: str, result_file: str) -> None:
...
def reclaimer_loop(zedclaw_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="zedclaw_mixed_stress_")
    print(f"ZEDCLAW_HOME = {home}")
