...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("zedclaw_cli.config.get_config_path", return_value=config_path), \
             patch("zedclaw_cli.config.ensure_zedclaw_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("zedclaw_cli.config.get_env_path", return_value=env_path), \
             patch("zedclaw_cli.config.ensure_zedclaw_home"):
    ...
    def test_ensure_zedclaw_home_sets_0700(self):
        home = Path(self.tmpdir) / ".zedclaw"
        with patch("zedclaw_cli.config.get_zedclaw_home", return_value=home):
