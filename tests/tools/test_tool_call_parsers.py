...
class TestParserRegistry:
    ...
    def test_zedclaw_parser_registered(self):
        parsers = list_parsers()
        assert "zedclaw" in parsers
...
# ─── ZedClaw parser tests ────────────────────────────────────────────────

class TestZedClawParser:
    @pytest.fixture
    def parser(self):
        return get_parser("zedclaw")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["zedclaw"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use zedclaw format since that's universal
