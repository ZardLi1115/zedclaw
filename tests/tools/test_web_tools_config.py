...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_zedclaw_home_override(self, tmp_path):
        """Auth lookup should read from ZEDCLAW_HOME/auth.json, not ~/.zedclaw/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".zedclaw").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``zedclaw tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
