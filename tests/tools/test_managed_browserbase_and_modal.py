...
def _enable_managed_nous_tools(monkeypatch):
    ...
    zedclaw_cli.auth and zedclaw_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("zedclaw_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("zedclaw_cli.models.check_nous_free_tier", lambda: False)
