...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from zedclaw_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZEDCLAW_OVERLAYS
        overlay = ZEDCLAW_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify zedclaw doctor recognizes Xiaomi env vars."""
