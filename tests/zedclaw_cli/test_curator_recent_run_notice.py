...
The notice prints the most recent curator run summary on `zedclaw update`,
...
session start) so users normally never see the rename map. `zedclaw update`
