...
The main() function in zedclaw_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zedclaw -c model`
...
def _build_parser():
    """Build a minimal replica of the zedclaw top-level parser."""
