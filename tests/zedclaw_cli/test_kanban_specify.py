"""Tests for the specifier module + `zedclaw kanban specify` CLI surface.
...
from zedclaw_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `zedclaw kanban …` argparse surface directly."""
