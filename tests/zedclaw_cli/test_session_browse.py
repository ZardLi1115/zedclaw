"""Tests for the interactive session browser (`zedclaw sessions browse`).
...
from zedclaw_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zedclaw sessions browse should be parseable."""
        from zedclaw_cli.main import main as _main_entry
