"""Tests for zedclaw_cli/goals.py — persistent cross-turn goals."""
...
def zedclaw_home(tmp_path, monkeypatch):
    """Isolated ZEDCLAW_HOME so SessionDB.state_meta writes don't clobber the real one."""
    ...
    # Bust the goal-module's DB cache for each test so it re-resolves ZEDCLAW_HOME.
    from zedclaw_cli import goals
...
class TestParseJudgeResponse:
    def test_clean_json_done(self):
        from zedclaw_cli.goals import _parse_judge_response
...
class TestJudgeGoal:
    def test_empty_goal_skipped(self):
        from zedclaw_cli.goals import judge_goal
...
class TestGoalManager:
    def test_no_goal_initial(self, zedclaw_home):
    ...
    def test_set_then_status(self, zedclaw_home):
        from zedclaw_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, zedclaw_home):
        from zedclaw_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, zedclaw_home):
        from zedclaw_cli.goals import GoalManager
    ...
    def test_clear(self, zedclaw_home):
        from zedclaw_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, zedclaw_home):
    ...
    def test_evaluate_after_turn_done(self, zedclaw_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, zedclaw_home):
        from zedclaw_cli import goals
        from zedclaw_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, zedclaw_home):
    ...
    def test_evaluate_after_turn_inactive(self, zedclaw_home):
    ...
    def test_continuation_prompt_shape(self, zedclaw_home):
        ...
        mgr.set("port goal command to zedclaw")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to zedclaw" in prompt
...
def test_goal_command_dispatches_in_cli_registry_helpers():
    ...
    from zedclaw_cli.commands import COMMANDS, COMMANDS_BY_CATEGORY
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, zedclaw_home):
        """N=3 consecutive parse failures → auto-pause with config pointer."""
        from zedclaw_cli import goals
        from zedclaw_cli.goals import GoalManager, DEFAULT_MAX_CONSECUTIVE_PARSE_FAILURES
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, zedclaw_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, zedclaw_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from zedclaw_cli import goals
        from zedclaw_cli.goals import GoalManager, load_goal
