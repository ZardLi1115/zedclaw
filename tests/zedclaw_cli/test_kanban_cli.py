"""Tests for the kanban CLI surface (zedclaw_cli.kanban)."""
...
from zedclaw_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from zedclaw_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_run_slash_board_override_restores_prior_env(kanban_home, monkeypatch):
    ...
    monkeypatch.setenv("ZEDCLAW_KANBAN_BOARD", "beta")

    kc.run_slash("--board alpha list")

    assert os.environ.get("ZEDCLAW_KANBAN_BOARD") == "beta"
